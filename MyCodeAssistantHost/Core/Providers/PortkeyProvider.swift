...
/// Portkey AI gateway provider implementation
public class PortkeyProvider: BaseLLMProvider {
    ...
    public override func transformRequest(_ request: UnifiedRequest) throws -> Data {
        ...
        if let functions = request.functions, !functions.isEmpty {
            requestBody["functions"] = try functions.map { function in
                [
                    "name": function.name,
                    "description": function.description,
                    "parameters": [
                        "type": function.parameters.type,
                        "properties": function.parameters.properties.mapValues { property in
